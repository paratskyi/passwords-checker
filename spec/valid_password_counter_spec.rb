RSpec.describe ValidPasswordCounter do
  ...
  let(:invalid_password_line_1) { 'c 2-4: asfalseiruqwo' }
  let(:invalid_password_line_2) { 'd 2-4: adsfdaldsedirduqwo' }

  let(:password_lines) { [] }
  let(:valid_password_lines) { [valid_password_line_1, valid_password_line_2] }
  let(:invalid_password_lines) { [invalid_password_line_1, invalid_password_line_2] }
  ...
  context 'without valid passwords' do
    let(:password_lines) { [invalid_password_line_1] }
  ...
  context 'with valid and invalid passwords' do
    let(:password_lines) do
      [valid_password_line_1, invalid_password_line_1, valid_password_line_2]
    end

    it { expect(subject).to eq valid_password_lines.count }

    context 'when there are many invalid passwords' do
      let(:password_lines) do
        [valid_password_line_1, invalid_password_line_1, valid_password_line_2, invalid_password_line_2]
      end
